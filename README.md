...
| [Rakurai Activation CLI](./cli/README.md) | Command-line tool for interacting with the Rakurai Activation program — initialize a [Rakurai Activation Account](./programs/rakurai_activation/README.md#4-rakurai-activation-account-creation), enable/disable the scheduler, and update commission settings. |
