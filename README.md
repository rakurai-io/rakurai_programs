...
| [Reward Distribution](./programs/reward_distribution/README.md) | Distributes block rewards to stakers via post-epoch Merkle claims; tracks off-path tip and mev-share revenue in per-validator [Tip & MevShare Collection Accounts](./programs/reward_distribution/README.md#tip--mevshare-collection-accounts) (TCA / MCA). |
