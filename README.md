...
| [Rakurai Client Config](./programs/rakurai_client_config/README.md) | On-chain validator settings: block-engine endpoints, post-pack (P2C) URLs, and virtual-priority maps — global defaults plus per-vote overrides. |
...
| [Client Config CLI](./cli/client_config.md) | Configure block-engine, P2C, and virtual-priority for validators — global, per-vote, proposals (`rakurai-client-config`). |
