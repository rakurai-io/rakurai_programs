...
- **[Initialize RAA](#32-init)**
- **[Enable or disable the scheduler](#33-scheduler-control)**
- **[Update commission](#34-update-commission)**
- **[Display RAA state](#35-show)**
...
- `-u, --url <URL>`: RPC URL of the target Solana cluster or moniker (for the testnet cluster, use `-ut` or `-u https://api.testnet.solana.com`).
